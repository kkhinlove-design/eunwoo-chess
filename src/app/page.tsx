...
export default function Home() {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (existing) {
        ...
        setPlayer(newPlayer);
        localStorage.setItem('chess_player_id', newPlayer.id);
        loadAllPlayers();
      }
    } catch {
  ...
  const handleSelectPlayer = (p: Player) => {
    setPlayer(p);
    localStorage.setItem('chess_player_id', p.id);
  };
      ...
      <div className="min-h-screen p-4 py-8">
        <div className="max-w-md mx-auto">
          <div className="game-card text-center mb-4">
            ...
            <h1 className="text-3xl font-bold text-purple-700 mb-1">은우의 체스</h1>
            <p className="text-purple-400 mb-5">친구들과 함께 즐기는 체스!</p>
